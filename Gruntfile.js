        ...
        watch: {
            ...
            livereload: {
                ...
                files: [
                    ...
                    '<%= yeoman.app %>/scripts/templates/*.{jade,mustache,hbs}',
                    'test/spec/**/*.js'
                ]
            },
            jade: {
                files: [
                    '<%= yeoman.app %>/scripts/{,*/}*.jade'
                ],
                tasks: ['jade']
            },
            test: {
        ...
        connect: {
            options: {
                ...
                middleware: function(connect, options, middlewares){
                  return [require('grunt-connect-pushstate/lib/utils').pushState(), connect.static(options.base)]
                  // console.log(connect);
            ...
            dist: {
                ...
                options: {
                    ...
                    paths: {
                        ...
                        'backbone.marionette': '../../<%= yeoman.app %>/bower_components/backbone/backbone.marionette'
                    },
